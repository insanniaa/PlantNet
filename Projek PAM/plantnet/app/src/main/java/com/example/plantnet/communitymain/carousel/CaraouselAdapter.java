...
public class CaraouselAdapter extends RecyclerView.Adapter<CaraouselAdapter.ViewHolder>{
    private Context context;
    private ArrayList<String> arrayList;
    private OnItemClickListener onItemClickListener;

    public CaraouselAdapter(Context context, ArrayList<String> arrayList){
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.carousel_community_list_item, parent, false);
