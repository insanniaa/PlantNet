...
public class TrendingAdapter extends RecyclerView.Adapter<TrendingAdapter.CommunityViewHolder> {
    ...
    public TrendingAdapter(Context context, List<Communities> communityList, OnItemClickListener onItemClickListener) {
    ...
    public CommunityViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.container_trending, parent, false);
    ...
    public void onBindViewHolder(@NonNull CommunityViewHolder holder, int position) {
        ...
        holder.description.setText(community.getDetail());
        Glide.with(context)
    ...
    public static class CommunityViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView communityTitle, description;
        ImageView communityImage;
        OnItemClickListener onItemClickListener;

        public CommunityViewHolder(View itemView, OnItemClickListener onItemClickListener) {
            super(itemView);
            communityTitle = itemView.findViewById(R.id.title_component);
            communityImage = itemView.findViewById(R.id.iv_component);
            description = itemView.findViewById(R.id.desc_component);
            this.onItemClickListener = onItemClickListener;
